        ...
        <section className="relative overflow-hidden bg-secondary section-padding-hero">
          <div className="container mx-auto">
            ...
            <p className="text-base sm:text-lg text-secondary-foreground/70 max-w-2xl">
              Every AED ready. Every day. Every time. An Irish company specialising in connected defibrillators,
              AED readiness management and emergency response training.
            </p>
          </div>
        </section>
